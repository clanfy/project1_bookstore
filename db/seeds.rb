...
book2.save()
book3 = Book.new({'title' => 'Harry Potter and the Philosopher''s Stone', 'author_id' => author2.id })
book3.save()
book4 = Book.new({'title' => 'Harry Potter and the Deathly Hallows', 'author_id' => author2.id })
book4.save()

stock1 = Stock.new({'book_id'=> book1.id, 'author_id' => book1.author.id, 'quantity' => 2})
stock1.save()
stock2 = Stock.new({'book_id'=> book2.id, 'author_id' => book2.author.id, 'quantity' => 1})
stock2.save()
